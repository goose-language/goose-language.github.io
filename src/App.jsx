...
export default function App() {
  return <header className="mx-auto h-screen grid place-items-center py-16">
    <div className="max-w-5xl mx-auto">
      <h1 className="text-5xl font-title font-black w-3/4 text-white tracking-wide text-center mx-auto">
        Uncover the true power of <span className="text-cyan-300 text">Goose language</span>
      </h1>
      <p className="text-xl text-white mx-auto w-3/4 text-center mt-6 opacity-70 font-light">
      ...
      <div className="flex max-w-2xl mx-auto w-full gap-4 mt-6">
